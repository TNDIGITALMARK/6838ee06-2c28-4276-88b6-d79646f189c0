 ...
 * Matching the design reference style: simple line icons with geometric shapes
 */
...
export const BrainIcon = ({ className = '' }: { className?: string }) => (
  ...
  >
    <path d="M12 5a3 3 0 0 0-3 3v4a3 3 0 0 0 3 3 3 3 0 0 0 3-3V8a3 3 0 0 0-3-3z" />
    <path d="M12 15v4" />
    <path d="M8 15.5c-1.5 0-3 1-3 3" />
    <path d="M16 15.5c1.5 0 3 1 3 3" />
  </svg>
);
...
export const DoubleChevronIcon = ({ className = '' }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
